...
function SearchMovieRoute({
  ...
  useEffect(() => {
    const getSearch = async () => {
      const response = await axios({
        method: "get",
        url: `https://api.themoviedb.org/3/search/movie?api_key=59540ca3d1f963deca67c4eaf91a2dc5&language=en-US&query=${searchWords}&page=1&include_adult=false`,
      });
  ...
  const searchedFilms = useApi(
    `search/movie?api_key=59540ca3d1f963deca67c4eaf91a2dc5&language=en-US&query=${searchWords}&page=1&include_adult=false`
  ); */
